...
var $author$project$Main$DataInput = function (a) {
	return {$: 'DataInput', a: a};
};
var $author$project$Main$ParseRawData = {$: 'ParseRawData'};
...
var $author$project$Main$uiStateToString = function (state) {
	if (state.$ === 'InputtingRawData') {
		return 'Inputting Data';
	} else {
		return 'Parsing...';
	}
};
var $author$project$Main$view = function (model) {
	var textAresId = 'parserTextarea';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Big 5 Parser')
									])),
								A2(
								$elm$html$Html$span,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('badge bg-primary')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Main$uiStateToString(model.uiState))
									]))
							])),
						A2(
						$elm$html$Html$label,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for(textAresId),
								$elm$html$Html$Attributes$class('form-label')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Parser Input')
							])),
						A2(
						$elm$html$Html$textarea,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id(textAresId),
								$elm$html$Html$Attributes$class('form-control mb-3'),
								$elm$html$Html$Attributes$rows(10),
								$elm$html$Html$Attributes$value(model.rawData),
								$elm$html$Html$Events$onInput($author$project$Main$DataInput)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick($author$project$Main$ParseRawData)
							]),
						_List_fromArray(
							[
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"DataInput":["String.String"],"ParseRawData":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));